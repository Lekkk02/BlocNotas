<?php 
    ...
    if(isset($_GET['action']) ) {
      ...
      $file_to_open = __DIR__ . "${DIRSEP}txt${DIRSEP}${file_to_open_name}";
 ...
 */    }
  ...
  if(isset($_GET['delete'])){
    ...
    $pathToFile = __DIR__ . "${DIRSEP}txt${DIRSEP}${fileToDelete}";
    unlink($pathToFile);
  }
  if(isset($_GET['fileName'])){
    $fileRaw = $_GET['fileName'];
    $fileName =  __DIR__ . "${DIRSEP}txt${DIRSEP}${fileRaw}.txt";
...
<html lang="en">
  ...
  <nav class="navbar">
      <div class="dual-nav w-50 order-1 order-md-0">
        <div>
